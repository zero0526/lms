    ...
    if (userStr) {
      try {
        ...
        if (user.role === "ROLE_TEACHER") {
          alert("Teachers cannot view course details as students. Please manage your courses from the Teacher Dashboard.");
          return;
        }
        
        alert("This feature is only available for students. Please log in with a student account.");
        return;
