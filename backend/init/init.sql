...
ALTER TABLE questions
  ADD FOREIGN KEY (segment_id) REFERENCES videos(id);

-- ========== MCQ CONTENTS ==========
CREATE TABLE mcq_contents (
  id SERIAL PRIMARY KEY,
...
-- ========== RESPONSE MCQ ==========
CREATE TABLE response_mcq (
  id SERIAL PRIMARY KEY,
  response_id INT REFERENCES question_responses(id),
  choice_id INT REFERENCES mcq_contents(id),
  is_selected BOOLEAN
);
...
CREATE TABLE question_comments (
  ...
  question_id INT REFERENCES questions(id),
  user_id INT REFERENCES users(id),
  parent_comment_id INT REFERENCES question_comments(id),
  content TEXT,
  is_edited BOOLEAN DEFAULT FALSE,
  created_at TIMESTAMP DEFAULT now(),
  updated_at TIMESTAMP
...
CREATE TABLE meeting_sessions (
  ...
  status status_meeting DEFAULT 'upcoming'
);
